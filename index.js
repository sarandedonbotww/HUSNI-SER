// Script by HUSNI
// HUSNI SER | MONU CREDITS KALAYALLE😎
// ©Husni Bot 
const {
...
autoketik = false;
prefixStatus = true;
targetpc = "917025868709"; 
owner = "917025868709"; 
fakeyoi = "❌ʜᷝᴜⷮsᷤɴɪᷟsⷷᴇʀ❌"; 
HunterApi = "Ikyy69", 
xchillds = 'XChillDs' 
hardi = 'hardianto', 
valkey = "rivalgans", 
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`917025868709@s.whatsapp.net`]
   ...
   const isRegister = register.includes(sender)
    ...
    const totalhit = JSON.parse(fs.readFileSync("./lib/totalcmd.json"))[0]
      .totalcmd;
const daftar1 = `❑ Hi ${pushname} 🐦 ${ucapanWaktu} \n\n❑ monu ende bot aadyamaayano kaanunne verify cheyy🙂`
...
/*const reply = (teks) => {
			xeon.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/917025868709?text=hello`}}})
		}*/
...
xeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `Husni Bot Ofc.`, "footerText": "*_HUSNI SER_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`HUSNI SER 😎`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
// Katalog
const reply = (teks) => {
             res = xeon.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*Husni*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
             xeon.relayWAMessage(res)
        }
const fakewa = (teks) => {        
xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Husni`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/917025868709?text=hello`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nHUSNI SER😎. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/917025868709`,
                "mediaType": "10",
                "mediaUrl": `wa.me/917025868709`,
                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/917025868709`,
...
"mediaType": "2",
"thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
"mediaUrl": "https://youtube.com/channel/UCllom1TvXieyxcGaanSpMvA",
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "917025868709@s.whatsapp.net";
...
*Thank you for registering in the HUSNI SER😎 Database*
...
*「 HUSNI SER 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'ʜᴜsɴɪ', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered HUSNI SER*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =` ▢ 𝐇𝐢 ${pushname} \n ▢ 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : ${groups.length} \n ▢ 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : ${privat.length}\n ▢ 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : ${totalChat.length} \n ▢ 𝐒𝐩𝐞𝐞𝐝 : ${latensie.toFixed(4)} _Second_ \n ▢ 𝐀𝐜𝐭𝐢𝐯𝐞 : ${runtime(process.uptime())} \n ▢ 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : ${os.platform()}`
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: `HUSNI SER`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: fkontak})
...
╭──────────────────╯
│
│   DA MONU @${sender.split("@")[0]} 
│      
│                 [̲̅A̲̅][̲̅L̲̅][̲̅I̲̅][̲̅V̲̅][̲̅E̲̅] 
│
│    [̲̅❌̲̅][̲̅H̲̅][̲̅U̲̅][̲̅S̲̅][̲̅N̲̅][̲̅I̲̅][̲̅S̲̅][̲̅E̲̅][̲̅R̲̅][̲̅❌̲̅]
│
│  ▢ *ᴅᴇᴠᴇʟᴏʟᴇʀ* : ʜᴜsɴɪ sɪʀ
│  ▢ *ᴏᴡɴᴇʀ* :  ʜᴜsɴɪ sɪʀ
│  ▢ *ᴠᴇʀsɪᴏɴ* : 1.0
...
│
│  ❑ *ɢɪᴛʜᴜʙ ʟɪɴᴋ* :
│  https://github.com/Husnisir/Husni-SIR
│  
│  ❑ *ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋ* :
│  
...
case 'bugreport':
              ...
              xeon.sendMessage('917025868709@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
`
sendButMessage(from, menu, `HUSNI SER`, [
          {
            buttonId: `command`,
            buttonText: {
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://youtube.com/channel/UCllom1TvXieyxcGaanSpMvA"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply('Only owner can use this feature')
        xeon.toggleDisappearingMessages(from, 0)
...
break
//fun features by Husni
                case 'uglycheck':
					// source code by Husni⛔
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
                  sange = body.slice(1)
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'HUSNI SER', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, `HUSNI SER`, [
            {              
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             xeon.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 HUSNI SER BROADCASTING 」*\n\n${body.slice(4)}`})
}
...
Husnix = await fetchJson(`https://bx-hunter.herokuapp.com/api/xvideosearch?query=${c}&apikey=${HunterApi}`)
reply(mess.wait)
Husnix = Husnix.result
ini_txt = ""
for (var x of Husnix) {
...
case 'writelist':
  ...
  ▢ ${prefix}write Husni
  ▢ ${prefix}folioright Husni
  ▢ ${prefix}folioleft Husni
  ▢ ${prefix}writedown Husni
  ▢ ${prefix}writeleft Husni`)
  break
case 'folioleft':
if (!c) return reply('Where is the text bro??')
reply(mess.wait)
...
case 'waifu':
  ...
  break
case 'attp':
              if (args.length == 0) return reply(`Example: ${prefix + command} Husni`)
